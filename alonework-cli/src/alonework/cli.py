...
from alonework.commands import init, chat, generate, test, commit
from alonework.config import ConfigManager
from alonework.session import SessionManager
from alonework.utils.welcome_screen import show_welcome, WelcomeScreen, StatusBar
from alonework.utils.status_bar import InteractiveStatusBar
...
def main(
    ...
    if ctx.invoked_subcommand is None:
        ...
        if query:
            from alonework.commands.chat import start_interactive_with_query
        ...
        from alonework.commands.chat import start_interactive
...
from alonework.commands.agent import agent_commands
