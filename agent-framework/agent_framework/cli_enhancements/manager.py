...
class CliEnhancementsManager:
    ...
    def setup(
        ...
        """
        from agent_framework.cli_enhancements.worktree_manager import WorktreeManager
        ...
        from agent_framework.cli_enhancements.rules_loader import RulesLoader
        from agent_framework.cli_enhancements.claude_md_loader import ClaudeMdLoader
