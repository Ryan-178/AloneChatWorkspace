...
from agent_framework.code.shell_tool import ShellTool, ShellConfig, ShellResult, ShellType
from agent_framework.code.apply_patch import ApplyPatchTool, PatchResult
